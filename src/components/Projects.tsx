...
const projects = [
  {
    ...
    location: "3-комнатная, 78 м²",
    year: "2024",
    image: "/images/hously-1.png",
  },
  {
    id: 2,
    title: "Студия с открытой планировкой",
    category: "Ремонт под ключ",
  ...
  {
    id: 3,
    title: "Классика в новостройке",
    category: "Ремонт под ключ",
    location: "2-комнатная, 56 м²",
    year: "2023",
    image: "/images/hously-3.png",
  },
  {
    id: 4,
    title: "Лофт с кирпичной стеной",
    category: "Дизайн + ремонт",
    location: "2-комнатная, 64 м²",
    year: "2023",
